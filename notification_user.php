...
<div id="notification-popup">
    <div class="header">
        Notification
        <span class="close-btn" onclick="document.getElementById('notification-popup').style.display='none'">&times;</span>
    </div>
    <div class="content" id="popup-content"></div>
</div>

<script>
    let notifications = <?php 
        $notes = [];
    ...
    function showNotification(index) {
        ...
        // here if the notification are read he hide it
